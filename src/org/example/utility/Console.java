...
public class Console {
    ...
    /**
     * starts read org.example.commands and execute it while it is not an exit command
     */
    public void start() {
        ...
        while (executeFlag) {
            ...
            if (commandManager.getCommands().containsKey(inputCommand)) {
                ...
                userIO.writeln("No such command. Type \"help\" to get all org.example.commands with their names and descriptions");
            }
        }
    }
